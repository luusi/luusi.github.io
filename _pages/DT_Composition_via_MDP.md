...
The composition MDP is a function of the system service and the target service as follows: $\tilde{\mathcal{M}}(\tilde{\mathcal{Z}}, \tilde{\mathcal{T}}) = \langle S_{\tilde\mathcal{M}}, A_{\tilde\mathcal{M}}, T_{\tilde\mathcal{M}}, R_{\tilde\mathcal{M}} \rangle$, where $S_{\tilde\mathcal{M}}= \Sigma_{\tilde\mathcal{Z}}\times \Sigma_{\tilde\mathcal{T}} \times A \cup \{s_{\mathcal{M0}}\}$, $A_{\tilde\mathcal{M}}$=${a_{\mathcal{M0}},1,\dot,n}$, $T_{\tilde\mathcal{M}}(s_{\mathcal{M0}},a_{\mathcal{M0}},(\sigma_{z0},\sigma_{t0},a)) = P_t(\sigma_{t0},a)$, $T_{\tilde\mathcal{M}}((\sigma_z,\sigma_t,a),i$,$(\sigma$'$_z$,$\sigma$'$_t$,$a$'$))$= $P_t$($\sigma$'$_t$,$a$')$\cdot$ $P_z$($\sigma_z$'$\mid \sigma_z, \langle a,i\rangle)$,
